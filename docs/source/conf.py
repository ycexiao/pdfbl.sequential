...
# -*- coding: utf-8 -*-
#
# pdfbl.sequential documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("pdfbl.sequential")
except Exception:
...
# abbreviations
ab_authors = "members of the Billinge Group and PDF beamline at NSLS-II"
...
modindex_common_prefix = ["pdfbl.sequential"]
...
basename = "pdfbl.sequential".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "pdfbl.sequential.tex",
        "pdfbl.sequential Documentation",
        ab_authors,
        "manual",
    ),
]
